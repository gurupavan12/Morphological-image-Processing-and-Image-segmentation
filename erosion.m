%This function takes the image that has to be eroded as the first input
%argument, and the size of the mask with which it needs to be eroded as the second and
%third argument. 
